...
assistant turn through `delegate_agent` (the `Task` tool on this runtime):
```
delegate_agent capability("Explore", "Find [area1] files related to issue", "Scout area1")
delegate_agent capability("Explore", "Find [area2] patterns/usage", "Scout area2")
delegate_agent capability("Explore", "Find [area3] tests/dependencies", "Scout area3")
```
...
4. **Verification commands:** Run typecheck, lint, build, and tests through the
...
delegate_agent capability("run_shell", "Run build", "Verify build")
delegate_agent capability("run_shell", "Run tests", "Verify tests")
```
