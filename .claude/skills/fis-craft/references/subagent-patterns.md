...
The delegation capability is the `Task` tool on this runtime; resolve it against
the live tool surface rather than assuming the name.
...
## Project Management
Activate the installed project-management skill (MANDATORY at Finalize — not a subagent):
